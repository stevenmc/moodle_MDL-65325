...
$string['expectallfiletypes'] = 'Any type of file may be submitted';
$string['expectedfiletypes'] = 'You may submit files of the following types: {$a}';
$string['expectedsubmissioncount'] = 'You may submit up to {$a} files.';
